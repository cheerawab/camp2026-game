...
export function StoneFusionPanel() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-hidden pb-2">
      <Card
        className="bg-surface-raised grid shrink-0 grid-cols-[86px_1fr] items-center gap-3 rounded-[22px] px-3.5 py-3"
        aria-label="合成結果預覽"
      >
        <div
          className={[
      ...
      <div className="fusion-picker-scroll min-h-0 flex-1 space-y-2 overflow-y-auto pr-1 pb-1">
        <PickerSection
          title="選小石"
      ...
      <Card className="mt-0 grid shrink-0 grid-cols-[1fr_116px] items-center gap-2 rounded-[20px] px-3 py-2">
        <div className="min-w-0">
